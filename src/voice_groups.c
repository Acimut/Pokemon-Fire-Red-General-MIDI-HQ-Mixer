...
const union VoiceGroup voicegroup191[] =
{
    ...
    [TUBULAR_BELLS]         = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_014_tubular_bells, 255, 249, 0, 235),
    ...
    [TIMPANI]               = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_047_timpani, 255, 0, 255, 235),
    ...
    [PAD_4_CHOIR]           = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_091_pad_4_choir, 255, 0, 255, 235),
    ...
    [FX_6_GOBLINS]          = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_101_fx_6_goblins, 255, 0, 255, 235),
    ...
    [TINKLE_BELL]           = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_112_tinkle_bell, 255, 252, 0, 235),
    [AGOGO]                 = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_113_agogo, 255, 242, 0, 235),
    [STEEL_DRUMS]           = VOICE_KEYSPLIT(voicegroup_FE7_SteelDrums, KeySplitTable34),
    [WOODBLOCK]             = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_115_woodblock, 255, 0, 255, 235),
    [TAIKO_DRUM]            = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_116_taiko_drum, 255, 0, 255, 235),
    [MELODIC_TOM]           = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_117_melodic_tom, 255, 0, 255, 235),
    [SYNTH_DRUM]            = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_118_synth_drum, 255, 0, 255, 235),
    [REVERSE_CYMBAL]        = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_119_reverse_cymbal, 255, 0, 255, 235),
    [GUITAR_FRET_NOISE]     = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_120_guitar_fret_noise, 255, 0, 255, 235),
    [BREATH_NOISE]          = VOICE_KEYSPLIT(voicegroup_FE7_BreathNoise, KeySplitTable32),
    [SEASHORE]              = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_122_seashore, 255, 0, 255, 235),
    [BIRD_TWEET]            = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_123_bird_tweet, 255, 0, 255, 235),
    [TELEPHONE_RING]        = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_124_telephone_ring, 255, 0, 255, 235),
    [HELICOPTER]            = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_125_helicopter, 255, 0, 255, 235),
...
const union VoiceGroup voicegroup200[] =
{
...
const union VoiceGroup voicegroup208[] =
{
    [ACOUSTIC_GRAND_PIANO]  = VOICE_KEYSPLIT(voicegroup_FE7_AcousticGrandPiano, KeySplitTable6),
    [BRIGHT_ACOUSTIC_PIANO] = VOICE_KEYSPLIT(voicegroup_FE7_BrightAcousticPiano, KeySplitTable6),
    [ELECTRIC_GRAND_PIANO]  = VOICE_KEYSPLIT(voicegroup_FE7_ElectricGrandPiano, KeySplitTable6),
...
const union VoiceGroup voicegroup216[] =
{
    [ACOUSTIC_GRAND_PIANO]  = VOICE_KEYSPLIT(voicegroup_FE7_AcousticGrandPiano, KeySplitTable6),
    [BRIGHT_ACOUSTIC_PIANO] = VOICE_KEYSPLIT(voicegroup_FE7_BrightAcousticPiano, KeySplitTable6),
    [ELECTRIC_GRAND_PIANO]  = VOICE_KEYSPLIT(voicegroup_FE7_ElectricGrandPiano, KeySplitTable6),
    ...
    [TUBULAR_BELLS]         = VOICE_DIRECTSOUND(NOTE_060, 0, DirectSoundWaveData_FE7_014_tubular_bells, 255, 249, 0, 235),
    [DULCIMER]              = VOICE_KEYSPLIT(voicegroup_FE7_Dulcimer, KeySplitTable16),
    [DRUMKIT_POWER]         = VOICE_KEYSPLIT_ALL(voicegroup_Acimut_Drumkit_Standard),
    [PERCUSIVE_ORGAN]       = VOICE_KEYSPLIT(voicegroup_FE7_PercussiveOrgan, KeySplitTable17),
    [ROCK_ORGAN]            = VOICE_KEYSPLIT(voicegroup_FE7_RockOrgan, KeySplitTable17),
    [CHURCH_ORGAN]          = VOICE_KEYSPLIT(voicegroup_FE7_ChurchOrgan, KeySplitTable13),
    [REED_ORGAN]            = VOICE_KEYSPLIT(voicegroup_FE7_ReedOrgan, KeySplitTable17),
...
//used GUNSHOT as DRUMKIT_CM_64_32L
const union VoiceGroup voicegroup327[] =
{
    [ACOUSTIC_GRAND_PIANO]  = VOICE_KEYSPLIT(voicegroup_FE7_AcousticGrandPiano, KeySplitTable6),
    [BRIGHT_ACOUSTIC_PIANO] = VOICE_KEYSPLIT(voicegroup_FE7_BrightAcousticPiano, KeySplitTable6),
    [ELECTRIC_GRAND_PIANO]  = VOICE_KEYSPLIT(voicegroup_FE7_ElectricGrandPiano, KeySplitTable6),
