...
#define NUM_TRACKS_BGM 16 //default 10
...
// IWRAM bss
//static
extern struct MusicPlayerTrack gMPlayTrack_BGM[NUM_TRACKS_BGM];
extern struct MusicPlayerTrack gMPlayTrack_SE1[NUM_TRACKS_SE1];
extern struct MusicPlayerTrack gMPlayTrack_SE2[NUM_TRACKS_SE2];
extern struct MusicPlayerTrack gMPlayTrack_SE3[NUM_TRACKS_SE3];
