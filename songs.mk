...
#	--------------------------------------------------------------
#		ACIMUT's Voicegroup FE7
#	--------------------------------------------------------------

# FE7 Voicegroup + Drumkit CM-64/32L.
FE7_CM64 = 191

# FE7 Voicegroup + ACIMUT's Drumkit STANDARD.
ACIMUT_STD = 200

# FE7 Voicegroup + ACIMUT's Drumkit ROOM.
ACIMUT_ROOM = 208

# FE7 Voicegroup + ACIMUT's Drumkit POWER.
ACIMUT_POWER = 216

# FE7 Voicegroup + ACIMUT's Drumkit CM-64/32L.
ACIMUT_CM64 = 327
...
$(MID_SUBDIR)/mus_follow_me.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V068

$(MID_SUBDIR)/mus_rs_vs_trainer.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V080 -P1

$(MID_SUBDIR)/mus_rs_vs_gym_leader.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V080
...
$(MID_SUBDIR)/mus_hall_of_fame.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V079
...
$(MID_SUBDIR)/mus_caught_intro.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V094 -P5
...
$(MID_SUBDIR)/mus_caught.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V100
...
$(MID_SUBDIR)/mus_oak_lab.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V075
...
$(MID_SUBDIR)/mus_route3.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V083
...
$(MID_SUBDIR)/mus_sevii_123.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V084
...
$(MID_SUBDIR)/mus_net_center.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V096

$(MID_SUBDIR)/mus_pewter.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V084

$(MID_SUBDIR)/mus_oak.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V086
...
$(MID_SUBDIR)/mus_encounter_girl.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V051
...
$(MID_SUBDIR)/mus_new_game_instruct.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V085
...
$(MID_SUBDIR)/mus_celadon.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V070
...
$(MID_SUBDIR)/mus_victory_trainer.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G$(ACIMUT_STD) -V089
